...
<div>
    <div class="absolute z-1 min-h-screen h-full w-screen">
    ...
    <div class="absolute z-2 h-screen w-screen">
        <header class="flex flex-col h-screen text-2xl  text-center" id='home'>
