    ...
    <div class="flex flex-col text-2xl  text-center">
        <div class="mt-30 md:mt-15 bg-CppBlue/50 p-4 rounded-md flex flex-col m-auto content-center justify-center w-full max-w-2xl">
            ...
            <div class="flex flex-wrap justify-center gap-5">
                <a class="p-2.5 rounded-md bg-OrangeOrange hover:bg-PineappleYellow" href="https://discord.gg/rB2ucUaFnc" target="_blank">
                    <!-- <Icon icon={faDiscord} pad /> -->
                    Join Discord
                </a>
                <a class="p-2.5 rounded-md bg-OrangeOrange hover:bg-PineappleYellow" href="https://docs.google.com/forms/d/e/1FAIpQLSd2-Fe3A41_fNiEEJhipwjOufO4MyhF5iFQMT8B2Rex8Di2nQ/viewform?usp=header" target="_blank">
