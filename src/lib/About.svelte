    ...
    <div class="mb-8">
        ...
        <div class="flex flex-col sm:flex-row">
            <div class="flex flex-col">
                ...
                <p class="mb-5">
                    Any current university student is welcome! 
                    Whether you're a beginner or an experienced individual, the hackathon welcomes all levels of expertise. 
                    Partner companies provide challenges for participants to solve. 
                    They foster a collaborative environment where students can showcase their skills and creativity.
                </p>
            </div>
            <div class="flex flex-col">
